...
endpoint = os.getenv("ENDPOINT_URL", "https://genai-openai-beyondhuman.openai.azure.com/")  
deployment = os.getenv("DEPLOYMENT_NAME", "gpt-4o")  
search_endpoint = os.getenv("SEARCH_ENDPOINT", "https://ai-search-demo-beyondhumant.search.windows.net")  
search_key = os.getenv("SEARCH_KEY", "Zbfrg9M4H5MArGBUoP4vMiEIoEoJ5AO0BmRxh2xx9oAzSeDqWOqZ")  
search_index = os.getenv("SEARCH_INDEX_NAME", "beyond-human-index1")  
subscription_key = os.getenv("AZURE_OPENAI_API_KEY", "f1d10e27aa074f40bd06661117fdf416")  
